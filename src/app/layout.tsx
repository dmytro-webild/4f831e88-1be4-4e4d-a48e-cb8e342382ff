...
export const metadata: Metadata = {
  title: "AutoService Rhön | Autowerkstatt Bad Neustadt",  description: "Professionelle Autowerkstatt in Bad Neustadt für Wartung, Reparaturen und TÜV. Schneller Service, faire Preise, alle Fahrzeugmarken. Jetzt Termin vereinbaren!",  keywords: "Autowerkstatt Bad Neustadt, KFZ Reparatur Rhön, Auto Inspektion, Reifenservice, TÜV Vorbereitung",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "AutoService Rhön | Ihre lokale Autowerkstatt",    description: "Professionelle Autowerkstatt mit schnellem Service und fairen Preisen in Bad Neustadt. Alle Fahrzeugmarken.",    url: "https://autoservice-rhoen.de",    siteName: "AutoService Rhön",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/worker-follows-car-checklist-fixing-tires_482257-75661.jpg",        alt: "AutoService Rhön Werkstatt"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "AutoService Rhön – Autowerkstatt Bad Neustadt",    description: "Schneller Service, faire Preise, alle Fahrzeugmarken. Termin jetzt vereinbaren!",    images: ["http://img.b2bpic.net/free-photo/worker-follows-car-checklist-fixing-tires_482257-75661.jpg"],
  },
};
